...
class Ui
{
    ...
    function __construct()
    {
        ...
        if (defined('MW_INCLUDES_URL')) {
            ...
            $this->admin_logo = MW_INCLUDES_URL . 'img/kubion/logokubion-trans.png';
            $this->logo_live_edit = MW_INCLUDES_URL . 'img/kubion/logokubion-trans.png';
            $this->admin_logo_login = MW_INCLUDES_URL . 'img/kubion/logokubion-trans.png';
        }
        $this->set_default();
