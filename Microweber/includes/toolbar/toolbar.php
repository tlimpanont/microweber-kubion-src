        ...
        <ul>
          <li class="create-content-dropdown">
            <a href="javascript:;" class="tst-logo" title="Microweber"  >
                ...
                <div id="kubion-toolbar-logo" style="background: url('src/Microweber/includes/img/kubion/kubionlogo-icon-small.png') no-repeat center top+10px; width: 57px; height: 26px;"></div>
